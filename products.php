        ...
        <div class="row">
            <div class='col-md-3 '>
                <div class="card" style="width: 18rem;">
                    <img class="card-img-top" src="../E-com/images/American Tourister 32 Ltrs.jpg" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text text-center">500/-</p>
                        <a href="#" class="btn btn-primary">Add to Cart</a>
                        <a href="./single-product.php " class="btn btn-secondary">View more</a>
                    </div>
                </div>
            </div>
