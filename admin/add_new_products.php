...
if(isset($_POST['add_product_btn'])){
    ...
    product_category,product_color,product_image1,product_image2) VALUES("$product_name","$product_description","$product_price"
    ,"$product_quantity","$product_category","$product_color","$product_image1","$product_image2")';
